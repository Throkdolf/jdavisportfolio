...
const Menu = [
    ...
    },
    {
      ...
      category: "Systems",
      description: `This project was a part of my Advanced Computer Architecture course and was done in C++. The goal was to develop a trace driven simulator that could accurately measure the instructions
                    ...
                    ROB entries, and the commit stages which marks an instruction as completed and clears its destination register from the RAT. I also had to make the simulator superscalar and be
                    able to support a two wide pipline.`,
    },
    ...
    /* TODO: Fix Image for this one*/
    {
      ...
      category: "Frontend",
      description: `This was a personal project of mine. I wanted to learn some frontend and web development skills because I had not dipped my toes in that world yet.
                    I decied to use react as my framework because theres a lot of resources on it and it seemed relevantively easy to pick up. I followed a few YouTube tutorials and consulted
                    forums and chatgpt when I got stuck or needed to learn something. All and all I'm pretty proud of this website and am hoping to keep it updated with new features and projects. `,
    },
    {
      id: 4,
      image: Work4,
      ...
      category: "Systems",
      description: `I dedicated this section to all of the projects I did in my Intro to Information Security class. There were five projects each covering a different field of information security.
                    The first project covered application security and was primarily about buffer overflow and overcoming buffer overflow defenses. I had to implement python scripts which bypass these
                    defenses and open a shell. I had to overcome Data Execution Protection (DEP), Address space layout randomization (ASLR), and use Return Ortiented Programming (ROP) gadgets to spawn the shell.
                    The second project focused on cryptography where I had to implement a length extension attack on sha256 hashes, hash collisions on MD5 hashes, padding oracle attack, and RSA signature forgery.
                    The third project focused on web security where I had to implement several SQL injection attacks with varying degrees of security, Cross site scripting with different levels of text filering and
                    Cross-site request forgery.
                    The fourth project was a network security project where I had to identify suspicous network behavior in wireshark, establish a connection to a DNS resolver and make an any type DNS request and display
                    the results and finally create a time based one time password system ontop of a HMAC based one time password system.`,
    ...
    },
    {
      ...
      category: "Systems",
      description: `This was a project from my Advanced Computer Architecture course and was done in C++. The goal was to develop a trace drive cache simulator that would measure the instructions per clock cycle of a caches and dram with
                   different polices. I had to create a cache data structure which was composed of vectors of cache lines for each cache set. I also created a dram data structure which was composed of a number of banks and each bank would have a
                   row buffer. Then I developed the memory system that would access memory going down the hierarchy and would measure the delay incurred based on hits and misses. DRAM also had two different polices that could be set in the command line.
                   An open page in which the row buffer would stay open leading to a less costly delay on a dram hit, but a more costly delay on a dram miss and a closed page policy where hits and misses would incurr the same delay. `,
    },
    {
      id: 6,
      image: Work6,
      title: "Ævintýri",
      category: "Backend",
      description: `I did the project in collaboration with the Georgia Tech Vertically Integrated Project program. Ævintýri means adventure in icelandic and is a text adventure game in the style of old school multiuser dungeon (MUD) DOS games.
                   I worked on a script parser that could take in our custom .script file format and generate a playable map and story. I also created a help command that would display helpful information about how to interact with the game
                   and other useful commands. Finally, I wrote a custom test script and story to be generated by the script parser. `,
    },
  ];
